 ...
 * Оператор alishev_lessons.Switch похож на if. Используется вместо множества if когда нужно перебрать условия.
 * alishev_lessons.Switch принимает как числа так и строки
